...
export interface SedimentInjectionInfo { id: string; source_conversation_id: string; source_file_name: string; source_conversation_title: string; file_type: string; token_count: number; chunk_count: number; summary: string | null; injected_at: string | null; status?: string | null; display_name?: string }
