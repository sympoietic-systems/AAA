...
const SystemPromptViewer: React.FC<{ content: string }> = ({ content }) => {
...
const DiffractiveZoneViewer: React.FC<{ content: string }> = ({ content }) => {
