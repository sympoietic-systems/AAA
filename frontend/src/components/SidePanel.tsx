...
import type { ConversationFile, SkillInfo, SkillsResponse, MetricsResponse, TokenResponse, DiffractiveInfo, ImageMetadata, WebMetadata, DocumentMetadata, BeliefsResponse, SchedulerStatusResponse } from "../api/client"
import { getSkills, getMetrics, getTokens, getFileSummary, getBeliefs, getSchedulerStatus } from "../api/client"
  ...
  return (
    <div className="mt-2 border-t border-[#1a1a1a] pt-2">
      <div className="flex items-center gap-1.5 mb-2">
        ...
        <span className="text-[10px] text-[#888] font-mono">startup scheduler</span>
