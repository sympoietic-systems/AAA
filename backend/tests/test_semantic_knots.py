...
from backend.storage.repository import SemanticKnotRepository, ConversationRepository
...
async def test_semantic_knot_compaction_trigger():
    ...
    mock_app_state.background_engine.run.assert_called_once_with("semantic_knot", {
        "text": expected_text
    })
