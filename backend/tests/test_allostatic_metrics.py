...
async def test_allostatic_metrics():
    ...
    regulator_mod = HomeostaticRegulatorModule()
    ...
    metrics_a1 = await metrics_mod.process({
        "embedding": emb_bytes,
        "embedding_dim": 384,
    ...
    conv_b = "conv_b"
    msg_b1 = repo.insert("human", "hello b", emb_bytes, "test", 384, conversation_id=conv_b)
    result_b1 = await metrics_mod.process({
        "embedding": emb_bytes,
        "embedding_dim": 384,
