...
Refactored from a monolithic 1839-line file into mixin-based modules:
  - mass_decay.py       → MassDecayMixin
  - dream_context.py    → DreamContextMixin
  - dream_prompts.py    → DreamPromptMixin
  - dream_executor.py   → DreamExecutorMixin
  - consolidation.py    → ConsolidationMixin
  - sedimentation.py    → pure utility functions
"""
...
from backend.core.mass_decay import MassDecayMixin
from backend.core.dream_context import DreamContextMixin
from backend.core.dream_prompts import DreamPromptMixin
from backend.core.dream_executor import DreamExecutorMixin
from backend.core.consolidation import ConsolidationMixin
