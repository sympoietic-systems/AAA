...
class SelfInitiationArbiterModule(ProcessingModule):
    ...
    async def process(self, payload: dict) -> dict:
        ...
        sedation_by_entropy = (
            glitch_fidelity is not None and glitch_fidelity >= 0.75 and entropy is not None and entropy < 0.03
        )
        ...
        if (sedation_by_entropy or sedation_by_similarity or sedation_by_collapse) and not payload.get(
            "grating_requested"
        ):
