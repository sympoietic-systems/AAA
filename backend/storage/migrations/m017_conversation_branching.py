...
def up(conn: sqlite3.Connection):
    ...
    try:
        conn.execute("ALTER TABLE conversation_log ADD COLUMN parent_message_id INTEGER REFERENCES conversation_log(id) ON DELETE SET NULL")
    ...
    try:
        conn.execute("ALTER TABLE consolidation_checkpoints ADD COLUMN message_id INTEGER REFERENCES conversation_log(id) ON DELETE SET NULL")
